...
* Exuberant Ctags                      : 日本語対応版を使う。for vim
...
* Edit bat
	...
	start %WD%mintty -i /msys2.ico /bin/env CHERE_INVOKING=1 /usr/bin/bash --login %* -c "export CHERE_INVOKING=1 && rm -rf /tmp/tmux* && cd /d/admin && tmux"
