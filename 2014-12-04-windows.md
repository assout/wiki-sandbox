...
* ShellCheck
* Vim(kaoriya)             : Refs. <2014-09-30-vim.md> : [Vim &mdash; KaoriYa](http://www.kaoriya.net/software/vim/)
...
* Apache Maven
* Apache Tomcat
* C/Migemo for Windows           : For vim-migemo : いったんmsys2 pacmanで入るやつ使う: [C/Migemo &mdash; KaoriYa](http://www.kaoriya.net/software/cmigemo/)
