...
* Java
	* Appearance
		* Members Sort Order
			* keep default : Types -> Static Fields -> Static Initializers -> Static Methods -> Fields -> Initializers -> Constructors -> Methods
	...
	* Editor
		...
		* Templates
			* test   : テスト雛形にSetup,Exercise,Verifyコメントを入れる
